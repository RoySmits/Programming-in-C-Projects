    ...
    public partial class MainWindow : Window
    {
        ...
        private void saveChanges_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                // TODO: Exercise 3: Task 3a: If an OptimisticConcurrencyException occurs then another user has changed the same students earlier, 
                // then overwrite their changes with the new data (see the lab instructions for details)
            catch (OptimisticConcurrencyException)
            {
                // If the user has changed the dame students earlier, then overwrite their changes with the new data
            ...
            {
                // If some sort of database exceprion has occurred, then display the reason for te excepion and rollback
            ...
            {
                // TODO: Exercise 3: Task 3c: If some other sort of error has occurs, report the error to the user and retain the data so the user can try again - 
                // the error may be transitory (see the lab instructions for details)
